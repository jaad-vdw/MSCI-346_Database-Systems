...
WHERE  Album.Artist_ID = Artist.Artist_ID and Song.Album_ID = Album.Album_ID and Artist.Artist_Name LIKE ? ";
//does this change 
...
//i need to put the add to playlist function right here 
...
//prints output of query in table
echo '<table>';
	echo '<tr>';
		echo '<th>Song ID</th>';
